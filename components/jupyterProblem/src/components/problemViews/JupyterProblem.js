...
const problemSolutionSubmitRequest = () => {};
const problemSolveSuccess = () => {};
const problemSolveUpdate = () => {};
      ...
      <Fragment>
        <Paper style={{ margin: '24px 2px' }}>
          <Typography variant="headline">
            Calculated Solution{solution && solution.failed && ' - Failing - Final output should be empty'}
          </Typography>
          <TextField
            InputLabelProps={{
              style: {
          ...
          solution.provided && (
            <Paper style={{ margin: '24px 2px' }}>
              <Typography style={{ position: 'relative' }} variant="headline">
                ...
                >
                  {this.state.collapses.provided ? <ExpandLessIcon /> : <ExpandMoreIcon />}
                </IconButton>
              </Typography>

              <Collapse collapsedHeight="10px" in={this.state.collapses.provided}>
                <div
                  style={{
                    textAlign: 'left',
                  }}
        ...
        <Paper style={{ margin: '24px 2px' }}>
          ...
          <Typography align="right" variant="caption">
            <a href={problem.problemColabURL} rel="noopener noreferrer" target="_blank">
              Link
            </a>
          </Typography>
        </Paper>
